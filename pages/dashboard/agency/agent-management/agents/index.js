...
export default function Agents({
    ...
    const { data: searchBarData, error: searchBarDataError } = useSWR(`${testEnv}v1/external/agent/search/all?pattern=${searchField}&pageNo=${entryValue.page}&pageSize=${entryValue.size}`, fetching)
