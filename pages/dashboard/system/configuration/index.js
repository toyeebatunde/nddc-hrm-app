...
export default function Configuration({ modals, setModalState, setToken }) {
    ...
    return (
        ...
        //     </div>
        // </div>
        <section className="p-4 mt-5 w-full grid grid-cols-1 sm:grid-cols-2 xlg:grid-cols-3 gap-[50px] min-h-[400px]">
