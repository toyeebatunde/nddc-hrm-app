...
export default function Roles({ modals, setModalState, setToken, setActiveDashboard, setActiveState, entryValue, pageSelector, setActiveTab, setLoading, resetPage, searchField, resetSearchParams, setSearchParam }) {
    const initialPermissions = [
        ...
        {
            category: "ATTENDANCE/TIME MANAGEMENT",
            sub: []
        },
        {
                ...
                <form className="flex flex-col w-full  mt-5">
                    ...
                    <section className="flex flex-col w-full lg:w-[60%]">
                        <section className="flex mt-4 flex-col">
                            <p className="font-500 text-[18px] leading-[23px] font-pushpennyMedium">EMPLOYEE MANAGEMENT</p>
                        ...
                        <section className="flex mt-4 flex-col">
                            <p className="font-500 text-[18px] leading-[23px] font-pushpennyMedium">ATTENDANCE/TIME MANAGEMENT</p>
                        ...
                        <section className="flex mt-4 flex-col">
                            <p className="font-500 text-[18px] leading-[23px] font-pushpennyMedium">PAYROLL MANAGEMENT</p>
                        ...
                        <section className="flex mt-4 flex-col">
                            <p className="font-500 text-[18px] leading-[23px] font-pushpennyMedium">PERFORMANCE MANAGEMENT</p>
                        ...
                        <section className="flex mt-4 flex-col">
                            <p className="font-500 text-[18px] leading-[23px] font-pushpennyMedium">LEARNING AND DEVELOPMENT</p>
