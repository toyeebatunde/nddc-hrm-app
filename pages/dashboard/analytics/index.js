    ...
    return (
        <div className="flex flex-col items-center pt-[60px] w-full">
            ...
            <section className="flex flex-col xl:flex-row items-center w-full  justify-between px-4 py-2 ">
                ...
                <section className="w-[400px] xl:ml-[5px] xl:mt-0 border rounded-[8px] mt-[10px] border-[#dddddd] h-[375px] flex flex-col items-center justify-between py-4">
            ...
            <section className="flex flex-col xl:flex-row items-center justify-between w-full px-4 mt-4">
                <section className="w-[396px] border rounded-[8px] border-[#dddddd] h-[381px] flex flex-col items-center justify-between py-2 ">
                    <section className="flex justify-between w-full px-4">
                    ...
                    <section className="flex w-full justify-between">
                        <section className="flex pl-2 justify-around flex-col">
