    ...
    return (
        <div className="flex flex-col items-center  w-full">
            ...
            <section className=" sticky top-0 pb-[5px] pt-[60px] z-[100] bg-[white] w-full">
                ...
                <section className={`px-4 ${activeAgency == "Payment" ? "hidden" : activeAgency == "POSTerminals" ? "hidden" : activeAgency == "TicketManagement" ? "hidden" : "flex"} justify-center w-full ${modals.isOpen ? "blur-sm" : "blur-none"}`}>
