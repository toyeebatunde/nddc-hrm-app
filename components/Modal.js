...
export default function Modals({ modal, closeModal, values, formFields, setFormFields, formEdit, modalSuccessNotify, modalCloser, setLoading, closeEdge }) {
    ...
    function handleFormDetailsChange(e) {
        e.preventDefault()
    ...
    //                 </button>
    //             </section>
    //             <p className="font-pushpennyBook font-[700] text-[12px] md:text-[18px] leading-[26px]">Send an invitation to a mentor</p>
    ...
    if (modal.teamModal) {
        return (
            ...
            <Modal
                open={modal.teamModal}
                onClose={close}
            >
                <Box component={"div"} className="w-fit absolute translate-y-[-50%] translate-x-[-50%] top-[50%] left-[50%]">
                    <Box component={"section"} className={`w-[350px] lg:rounded-[48px] lg:w-[654px] py-[20px] px-[20px] flex flex-col items-center min-h-[634px] bg-white rounded-[15px]`}>
                        <Box component={"section"} className="flex w-[95%] lg:w-[70%] lg:mr-[40px] lg:self-end justify-between">
                            <p className="font-pushpennyBold font-700 text-[28px] leading-[36.46px]">{values.values.heading || "Invite a team mate"}</p>
                            <button onClick={(e) => { modalCloser(false, "editCharges") }} className="w-[40px] h-[40px] relative cursor-pointer">
                                <ImageHolder id="closer" onClick={(e) => { closeModal(e) }} src="/icons/close-modal.svg" />
                            </button>
                        ...
                        <form className="flex flex-col justify-between w-full mt-[10px] min-h-[333px]">
                            <section className="flex  flex-col lg:flex-row lg:justify-between gap-[20px] lg:gap-0 relative self-center items-center w-[95%]">
                                <div className="flex items-center justify-center w-[90%] lg:w-[232px] h-[62px] relative rounded-[28.5px]">
                                    <Textfield editable={true} type="text" formEdit={handleFormDetailsChange} value={formDetails.firstname} title="First Name" name="firstname" />
                                </div>
                                <div className="flex items-center justify-center w-[90%] lg:w-[232px] h-[62px] relative rounded-[28.5px]">
                                    <Textfield editable={true} type="text" formEdit={handleFormDetailsChange} value={formDetails.lastname} title="Last Name" name="lastname" />
                                </div>
                            </section>
                            <section className={`${values.values.privileges ? "hidden" : "flex"}  flex-col mt-[20px] lg:mt-0 lg:flex-row lg:justify-between gap-[20px] lg:gap-0 relative self-center items-center w-[95%]`}>
                                <div className="flex items-center justify-center w-full h-[62px] relative rounded-[28.5px]">
                                    <Textfield editable={true} formEdit={handleFormDetailsChange} value={formDetails.email} type="text" title="Email" name="email" />
                                </div>
                            </section>
                            <section className={`${values.values.privileges ? "hidden" : "flex"}  flex-col mt-[20px] lg:mt-0 lg:flex-row lg:justify-between gap-[20px] lg:gap-0 relative self-center items-center w-[95%]`}>
                                <div className="flex items-center justify-center w-full h-[62px] relative rounded-[28.5px]">
                                    <Textfield editable={true} formEdit={handleFormDetailsChange} value={formDetails.phoneNumber} type="text" title="Phone Number" name="phoneNumber" />
                                </div>
                            </section>
                            <section className="flex flex-col mt-[20px] lg:mt-0 lg:flex-row lg:justify-between gap-[20px] lg:gap-0 relative self-center items-center w-[95%]">
                                <div className="flex items-center justify-center w-full h-[62px] relative rounded-[28.5px]">
                                    <Textfield formEdit={handleFormDetailsChange} value={formDetails.role} type="select" selectOptions={values.values.selectOptions} title="Assign Role" name="role" />
                                </div>
                            </section>
